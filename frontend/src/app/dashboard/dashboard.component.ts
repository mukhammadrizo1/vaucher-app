...
export class DashboardComponent implements OnInit {
  ...
  async loadDocuments() {
    ...
    try {
      const data = await this.documentApiService.getDocumentDetails();
  ...
  async saveDocument(updatedDoc: DocumentDetails) {
    try {
      ...
      await this.documentApiService.updateDocumentDetails(originalDoc.id, docToSave);
  ...
  async confirmDelete() {
    ...
    try {
      await this.documentApiService.deleteDocumentDetails(doc.id);
